...
.notfound{margin:0px;height:100%; font-family:"微软雅黑";}
i{ font-style:normal;}
...
.error_new_content { width: 100%; height: 100%; text-align: center; margin: 0 auto; background: url(/static/img/error.png) no-repeat center center; min-width: 1000px; }
